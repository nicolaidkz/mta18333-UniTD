...
public class WaveSpawner : MonoBehaviour
{
    ...
    IEnumerator SpawnWave(Wave _wave)
    {
        ...
        {
            // we then call our spawnEnemy method and pass it the wave we took in as the arguement follow by the enemy prefab that is passed to the enemy variable in the inspector
            SpawnEnemy(_wave.enemy);
            // here we set the time between each enemy of the wave will spawn by using the spawnRate variable in the inspector
