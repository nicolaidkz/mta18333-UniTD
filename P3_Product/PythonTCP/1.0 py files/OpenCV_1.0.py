...
class OpenCV:
    ...
    #     plt.imshow(img_,
    #                cmap='gray')                             # now we call the show image feature of plt (and make sure to not show intensity with color!)
    ...
    # errorCode = detectShape(template_p1t1, testImg, p1t1_array)
    #
    # print(p1t1_array)
    # print(errorCode)
    # showImg(testImg)